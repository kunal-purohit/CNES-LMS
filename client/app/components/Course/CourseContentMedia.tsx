...
const CourseContentMedia = ({
  ...
  return (
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      {/* Enable this in order to activate video player feature */}
      {/* <div className="mt-12">
        <CoursePlayer
      ...
      <div>
        {data[activeVideo]?.links.map((item: any, index: number) => (
          <div className="mb-5 flex justify-center" key={index}>
            <div className="w-full max-w-screen-lg aspect-w-8 aspect-h-11 mt-0">
              <iframe
                src={item.url}
        ...
        <div>
          {data[activeVideo]?.links.map((item: any, index: number) => (
            <div className="mb-5 flex justify-center" key={index}>
              ...
              {/* -------------for resources ebook gdrive section---------------- */}

              <div className="w-full max-w-screen-lg aspect-w-8 aspect-h-11">
                <iframe
                  src={item.url}
